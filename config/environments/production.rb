...
Rails.application.configure do
  ...
  config.assets.precompile += %w(fonts/* images/*)
  ...
  # config.active_job.queue_name_prefix = "betatech_production"
  ...
  config.action_mailer.default_url_options = { host: 'https://www.betatechpk.com/' }
